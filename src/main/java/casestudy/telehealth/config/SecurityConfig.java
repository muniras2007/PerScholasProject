...
import casestudy.telehealth.security.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/pub/**","/","/error/**","/registration-url-path/**", "/productListSearch","/login/**","/homepage","/productDisplay/**").permitAll()
